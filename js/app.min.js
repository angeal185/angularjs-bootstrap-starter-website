function _init() {
    ...
    $.mainThm.layout = {
        ...
        fix: function() {
            ...
            if ($("body").hasClass("fixed")) $(".content-wrapper, .right-side").css("min-height", b - $(".main-footer").outerHeight());
                ...
                var e = $($.mainThm.options.controlSidebarOptions.selector);
                "undefined" != typeof e && e.height() > d && $(".content-wrapper, .right-side").css("min-height", e.height())
            }
        },
        fixSidebar: function() {
            return $("body").hasClass("fixed") ? ("undefined" == typeof $.fn.slimScroll && window.console && window.console.error("Error: the fixed layout requires the slimscroll plugin!"), void($.mainThm.options.sidebarSlimScroll && "undefined" != typeof $.fn.slimScroll && ($(".sidebar").slimScroll({
                destroy: !0
        ...
        activate: function(a) {
            var b = $.mainThm.options.screenSizes;
            ...
            }), ($.mainThm.options.sidebarExpandOnHover || $("body").hasClass("fixed") && $("body").hasClass("sidebar-mini")) && this.expandOnHover()
        },
        expandOnHover: function() {
            var a = this,
                b = $.mainThm.options.screenSizes.sm - 1;
    ...
    }, $.mainThm.tree = function(a) {
        var b = this,
            c = $.mainThm.options.animationSpeed;
    ...
    }, $.mainThm.controlSidebar = {
        activate: function() {
            var a = this,
                b = $.mainThm.options.controlSidebarOptions,
                c = $(b.selector),
        ...
        selectors: $.mainThm.options.boxWidgetOptions.boxWidgetSelectors,
        icons: $.mainThm.options.boxWidgetOptions.boxWidgetIcons,
        animationSpeed: $.mainThm.options.animationSpeed,
        activate: function(a) {
            var b = this;
...
if ("undefined" == typeof jQuery) throw new Error("mainThm requires jQuery");
$.mainThm = {}, $.mainThm.options = {
        ...
        "use strict";
        $("body").removeClass("hold-transition"), "undefined" != typeof mainThmOptions && $.extend(!0, $.mainThm.options, mainThmOptions);
        var a = $.mainThm.options;
        _init(), $.mainThm.layout.activate(), $.mainThm.tree(".sidebar"), a.enableControlSidebar && $.mainThm.controlSidebar.activate(), a.navbarMenuSlimscroll && "undefined" != typeof $.fn.slimscroll && $(".navbar .menu").slimscroll({
            height: a.navbarMenuHeight,
            alwaysVisible: !1,
            size: a.navbarMenuSlimscrollWidth
        }).css("width", "100%"), a.sidebarPushMenu && $.mainThm.pushMenu.activate(a.sidebarToggleSelector), a.enableBSToppltip && $("body").tooltip({
            selector: a.BSTooltipSelector
        }), a.enableBoxWidget && $.mainThm.boxWidget.activate(), a.enableFastclick && "undefined" != typeof FastClick && FastClick.attach(document.body), a.directChat.enable && $(document).on("click", a.directChat.contactToggleSelector, function() {
    ...
    function(a) {
        ...
        a.fn.activateBox = function() {
            a.mainThm.boxWidget.activate(this)
        }, a.fn.toggleBox = function() {
            var b = a(a.mainThm.boxWidget.selectors.collapse, this);
            a.mainThm.boxWidget.collapse(b)
        }, a.fn.removeBox = function() {
            var b = a(a.mainThm.boxWidget.selectors.remove, this);
            a.mainThm.boxWidget.remove(b)
        }
    }(jQuery),
    function(a) {
        "use strict";
